/**
 * UARE Workstation — app.js rewriter
 * Replaces app.js with clean boot code only
 */
import { writeFileSync } from 'fs';
const p = 'C:/Users/quant/OneDrive/UARE_enterprise_extracted/custom_backend/public/lab/app.js';
...
console.log('✓ app.js rewritten. Size:', Math.round(sz/1024) + 'KB');
